...
async fn main() -> Result<()> {
    // search and count present identical CLIs.
    // hard code size limits for now, until find a way 
    let search_and_count = |name| {
                            Command::new(name) 
                                ...
                                .arg(
                                    Arg::new("size")
                                        ...
                                        .long("size")
                                        .default_value("50")
                                        .help("The number of results to return. Max 50,000 currently."),
                                )
                                .arg(
                                    Arg::new("ranks")
                                        .short('R')
    ...
    let matches = Command::new("goat")
        ...
        .subcommand(
            Command::new("taxon")
                    .arg_required_else_help(true)
                    .about("Queries by taxon index.")
                    .subcommand(
                        search_and_count("search")
                    )
                    .subcommand(
                        search_and_count("count")
                    )
                    .subcommand(
                        Command::new("lookup")
        ...
        .subcommand(
            Command::new("assembly")
                    .arg_required_else_help(true)
                    .about("Queries by assembly index.")
                    .subcommand(
                        Command::new("search")
