...
lazy_static! {
    pub static ref GOAT_VARIABLE_DATA: BTreeMap<&'static str, Variable<'static>> = collection!(
		...
		"sample_collected" => Variable { display_name: "sample_collected", type_of: TypeOf::Keyword(vec!["dtol"]), functions: Function::None },
		"sample_acquired" => Variable { display_name: "sample_acquired", type_of: TypeOf::Keyword(vec!["dtol"]), functions: Function::None },
		"in_progress" => Variable { display_name: "in_progress", type_of: TypeOf::Keyword(vec!["dtol"]), functions: Function::None },
		"insdc_submitted" => Variable { display_name: "insdc_submitted", type_of: TypeOf::Keyword(vec!["dtol"]), functions: Function::None },
		"insdc_open" => Variable { display_name: "insdc_open", type_of: TypeOf::Keyword(vec!["dtol"]), functions: Function::None },
		"published" => Variable { display_name: "published", type_of: TypeOf::Keyword(vec!["dtol"]), functions: Function::None },
		"sample_collected_by" => Variable { display_name: "sample_collected_by", type_of: TypeOf::Keyword(vec!["mba", "nhm", "rbge", "kew", "san", "oxf"]), functions: Function::None },
		...
		"other_priority" => Variable { display_name: "other_priority", type_of: TypeOf::Keyword(vec!["cbp"]), functions: Function::None },
		"family_representative" => Variable { display_name: "family_representative", type_of: TypeOf::Keyword(vec!["cbp"]), functions: Function::None },
		"long_list" => Variable { display_name: "long_list", type_of: TypeOf::Keyword(vec!["asg"]), functions: Function::None },
