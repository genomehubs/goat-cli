...
lazy_static! {
    ...
    pub static ref GOAT_TAXON_VARIABLE_DATA: BTreeMap<&'static str, Variable<'static>> = collection!(
		...
		"long_list" => Variable { display_name: "long_list", type_of: TypeOf::Keyword(vec!["africabp", "ag100pest", "agi", "arg", "asg", "b10k", "canbp", "cbp", "ccgp", "cfgp", "dtol", "ebpn", "ein", "endemixit", "erga", "eurofish", "gaga", "gap", "gbr", "ilebp", "metainvert", "omg", "pgp", "squalomix", "tsi", "vgp", "zoonomia"]), functions: Function::None },
		"other_priority" => Variable { display_name: "other_priority", type_of: TypeOf::Keyword(vec!["africabp", "ag100pest", "agi", "arg", "asg", "b10k", "canbp", "cbp", "ccgp", "cfgp", "dtol", "ebpn", "ein", "endemixit", "erga", "eurofish", "gaga", "gap", "gbr", "ilebp", "metainvert", "omg", "pgp", "squalomix", "tsi", "vgp", "zoonomia"]), functions: Function::None },
		"family_representative" => Variable { display_name: "family_representative", type_of: TypeOf::Keyword(vec!["africabp", "ag100pest", "agi", "arg", "asg", "b10k", "canbp", "cbp", "ccgp", "cfgp", "dtol", "ebpn", "ein", "endemixit", "erga", "eurofish", "gaga", "gap", "gbr", "ilebp", "metainvert", "omg", "pgp", "squalomix", "tsi", "vgp", "zoonomia"]), functions: Function::None },
		"sequencing_status_omg" => Variable { display_name: "sequencing_status_omg", type_of: TypeOf::None, functions: Function::None },
		"sequencing_status_arg" => Variable { display_name: "sequencing_status_arg", type_of: TypeOf::None, functions: Function::None },
		"sequencing_status_tsi" => Variable { display_name: "sequencing_status_tsi", type_of: TypeOf::None, functions: Function::None },
		"sequencing_status_gap" => Variable { display_name: "sequencing_status_gap", type_of: TypeOf::None, functions: Function::None },
		"sequencing_status_gbr" => Variable { display_name: "sequencing_status_gbr", type_of: TypeOf::None, functions: Function::None },
		"sequencing_status_agi" => Variable { display_name: "sequencing_status_agi", type_of: TypeOf::None, functions: Function::None },
