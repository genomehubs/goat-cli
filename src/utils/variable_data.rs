...
lazy_static! {
    ...
    pub static ref GOAT_TAXON_VARIABLE_DATA: BTreeMap<&'static str, Variable<'static>> = collection!(
        ...
        "sequencing_status_ebp" => Variable { display_name: "sequencing_status_ebp", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
...
// I'll need another one of these for GOAT_ASSEMBLY_VARIABLE_DATA
