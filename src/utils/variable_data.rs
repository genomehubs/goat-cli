...
lazy_static! {
    ...
    pub static ref GOAT_TAXON_VARIABLE_DATA: BTreeMap<&'static str, Variable<'static>> = collection!(
		...
		"sample_collected_by" => Variable { display_name: "sample_collected_by", type_of: TypeOf::Keyword(vec!["dalu", "ghc", "mba", "nhm", "nsu", "psu", "qmul", "rbge", "kew", "san", "ubc", "derb", "oxf", "vien"]), functions: Function::None },
		...
		"sequencing_status" => Variable { display_name: "sequencing_status", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_ag100pest" => Variable { display_name: "sequencing_status_ag100pest", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_asg" => Variable { display_name: "sequencing_status_asg", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_b10k" => Variable { display_name: "sequencing_status_b10k", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_canbp" => Variable { display_name: "sequencing_status_canbp", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_cbp" => Variable { display_name: "sequencing_status_cbp", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_ccgp" => Variable { display_name: "sequencing_status_ccgp", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_cfgp" => Variable { display_name: "sequencing_status_cfgp", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_dtol" => Variable { display_name: "sequencing_status_dtol", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_ebpn" => Variable { display_name: "sequencing_status_ebpn", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_endemixit" => Variable { display_name: "sequencing_status_endemixit", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_erga" => Variable { display_name: "sequencing_status_erga", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_eurofish" => Variable { display_name: "sequencing_status_eurofish", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_gaga" => Variable { display_name: "sequencing_status_gaga", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_giga" => Variable { display_name: "sequencing_status_giga", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_ilebp" => Variable { display_name: "sequencing_status_ilebp", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_metainvert" => Variable { display_name: "sequencing_status_metainvert", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_pgp" => Variable { display_name: "sequencing_status_pgp", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_squalomix" => Variable { display_name: "sequencing_status_squalomix", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_vgp" => Variable { display_name: "sequencing_status_vgp", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_zoonomia" => Variable { display_name: "sequencing_status_zoonomia", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_omg" => Variable { display_name: "sequencing_status_omg", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_arg" => Variable { display_name: "sequencing_status_arg", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_agi" => Variable { display_name: "sequencing_status_agi", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_tsi" => Variable { display_name: "sequencing_status_tsi", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_gap" => Variable { display_name: "sequencing_status_gap", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"sequencing_status_gbr" => Variable { display_name: "sequencing_status_gbr", type_of: TypeOf::Keyword(vec!["published", "insdc_open", "in_progress", "sample_acquired", "sample_collected"]), functions: Function::None },
		"long_list" => Variable { display_name: "long_list", type_of: TypeOf::Keyword(vec!["africabp", "ag100pest", "agi", "arg", "asg", "b10k", "canbp", "cbp", "ccgp", "cfgp", "dtol", "ebpn", "ein", "endemixit", "erga", "eurofish", "gaga", "gap", "gbr", "giga", "ilebp", "metainvert", "omg", "pgp", "squalomix", "tsi", "vgp", "zoonomia"]), functions: Function::None },
		"other_priority" => Variable { display_name: "other_priority", type_of: TypeOf::Keyword(vec!["africabp", "ag100pest", "agi", "arg", "asg", "b10k", "canbp", "cbp", "ccgp", "cfgp", "dtol", "ebpn", "ein", "endemixit", "erga", "eurofish", "gaga", "gap", "gbr", "giga", "ilebp", "metainvert", "omg", "pgp", "squalomix", "tsi", "vgp", "zoonomia"]), functions: Function::None },
		"family_representative" => Variable { display_name: "family_representative", type_of: TypeOf::Keyword(vec!["africabp", "ag100pest", "agi", "arg", "asg", "b10k", "canbp", "cbp", "ccgp", "cfgp", "dtol", "ebpn", "ein", "endemixit", "erga", "eurofish", "gaga", "gap", "gbr", "giga", "ilebp", "metainvert", "omg", "pgp", "squalomix", "tsi", "vgp", "zoonomia"]), functions: Function::None },
...
lazy_static! {
    ...
    pub static ref GOAT_ASSEMBLY_VARIABLE_DATA: BTreeMap<&'static str, Variable<'static>> = collection!(
		...
		"sample_location" => Variable { display_name: "sample_location", type_of: TypeOf::None, functions: Function::None },
